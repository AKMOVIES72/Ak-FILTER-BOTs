...
auth_channel = environ.get('AUTH_CHANNEL', '-1003757252744') # give your force subscribe channel id here else leave it blank
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'http://ibb.co/Gv7zxG6P') # payment code picture url.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AKMOVIESSTELUGU')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+qA6Hx9bIbEEyZmM1') # Support Chat Link Without https:// or @
...
TUTORIAL = environ.get('TUTORIAL', 'http://t.me/Akofficialadmin_bot') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
